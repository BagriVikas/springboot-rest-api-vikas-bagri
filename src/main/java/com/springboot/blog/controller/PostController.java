...
public class PostController {
    ...
    @Operation(
            ...
            description = "Create Post REST API is used to save a post in the database"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "Get Post By Id REST API is used to fetch a post by id from the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Http Status 200 SUCCESS"
    ...
    @Operation(
            ...
            description = "Delete Post By Id REST API is used to delete a post by id from the database"
    )
    @ApiResponse(
            responseCode = "200",
